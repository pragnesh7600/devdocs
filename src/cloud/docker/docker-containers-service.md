...
```bash
./vendor/bin/ece-docker build:compose --mailhog-smtp-port=1026 --mailhog-http-port=8025
```

After updating the configuration and restarting the Docker environment, you can use the service.

- Connect to the web interface: `http://magento2.docker:8025`

- Use port 1025 for SMTP communication.
